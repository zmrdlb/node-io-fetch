/**
 * @fileoverview 通过 fetch 发起并处理 resource 请求的配置。这个配置提供了一种结构，
 * 指导开发者如何提供 request 数据以及如何处理 response。
 */
...
that.ioparams = {
    ...
    isformdata: false,
    url: '', // resource url地址
    baseURL: '', // 如果 url 不是绝对地址，那么最终的请求 url 是 baseURL+url
    /**
